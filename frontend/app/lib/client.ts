...
export function Environment(name: string): BaseURL {
    return `https://${name}-ultimate-t282.encr.app`
}
...
/**
 * Client is an API client for the ultimate-t282 Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "ultimate-t282-Generated-TS-Client (Encore/v1.49.1)";
        }
